...
//
//
//    public ClientService(Socket socket, String nickName) throws IOException {
//        this.socket = socket;
...
//        for (ClientService client : SrvApp.getClients()) {
//            client.sendMessage("/newClient " + this.nickName);
//            this.sendMessage("/newClient " + client.getNickName());
//        }
...
//        for (ClientService client : SrvApp.getClients()) {
//            client.sendMessage("/removeClient " + this.nickName);
//        }
//    }
//
//    /**
